...
class VehicleCheckListAdapter(private val vehicleCheckList: List<VehicleCheck>, private val isReport: Boolean = false, private val onItemClick: ((VehicleCheck) -> Unit)?): RecyclerView.Adapter<VehicleCheckListAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val location = itemView.findViewById<TextView>(R.id.text_location)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.vehicle_check_item_row,parent,false)
